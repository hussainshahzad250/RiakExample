 ...
 * CreateTable.java
 * 
 * @author cvitter Demonstrates how to create a table in Riak TS via the Java
 *         Client API For more information see the Java Client API documentation
 *         at: http://docs.basho.com/riakts/latest/developing/java/
 */
public class CreateTable {
	...
	private static void createTable() throws UnknownHostException {
	    ...
	    String queryText = "CREATE TABLE P15 " + 
	    		"( " +
